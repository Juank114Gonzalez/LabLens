...
- Comparar con iniciativas históricas (mock en este MVP).
- Estimar un fit preliminar para priorización.

## Principios de evaluación

1. Impacto de negocio medible.
2. Disponibilidad y calidad de datos.
3. Patrocinio (sponsor) y ownership claro.
4. Complejidad técnica y operativa razonable.
5. Alineación con objetivos estratégicos del Lab.
